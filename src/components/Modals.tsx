        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full text-xs p-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-rose-500 focus:outline-none min-h-[40px]"
            />
          </div>
          ...
          <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-100">
            ...
            <button
              type="submit"
              className="px-4 py-2 text-xs font-semibold text-white bg-rose-600 hover:bg-rose-700 rounded-lg transition-colors shadow-xs min-h-[38px]"
            >
              Confirmar Ausência
            </button>
          </div>
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4 z-50">
      <div className="bg-white rounded-xl shadow-2xl max-w-md w-full p-4 sm:p-6 border border-slate-200 max-h-[90vh] overflow-y-auto animate-in fade-in">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div className="flex items-center gap-2">
            <Palmtree className="w-5 h-5 text-blue-600 shrink-0" />
        ...
        <form onSubmit={handleValidarOuSalvar} className="mt-4 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full text-xs p-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-blue-500 focus:outline-none min-h-[40px]"
              />
            </div>
            <div>
              <label className="block text-xs font-semibold text-slate-700 mb-1">
          ...
          <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-100">
            ...
            <button
              type="submit"
              className="px-4 py-2 text-xs font-semibold text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors shadow-xs min-h-[38px]"
            >
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4 z-50">
      <div className="bg-white rounded-xl shadow-2xl max-w-md w-full p-4 sm:p-6 border border-slate-200 max-h-[90vh] overflow-y-auto animate-in fade-in">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div className="flex items-center gap-2">
            <FileHeart className="w-5 h-5 text-amber-600 shrink-0" />
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                value={dataInicio}
                onChange={(e) => { setDataInicio(e.target.value); setAvisoConflitoVisivel(false); }}
                className="w-full text-xs p-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-amber-500 focus:outline-none min-h-[40px]"
              />
            </div>
            <div>
              <label className="block text-xs font-semibold text-slate-700 mb-1">
          ...
          <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-100">
            ...
            <button
              type="submit"
              className="px-4 py-2 text-xs font-semibold text-white bg-amber-600 hover:bg-amber-700 rounded-lg transition-colors shadow-xs min-h-[38px]"
            >
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full text-xs p-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-emerald-500 focus:outline-none min-h-[40px]"
            />
          </div>
